function LoadHomePanel()
	...
	HOME_STAFF.Paint = function( self, w, h )
		...
		draw.SimpleText( "STAFF ONLINE", "RP_SubFontThick", 24, 20, Color( 190, 190, 190 ) )
	...
	HOME_STATS.Paint = function( self, w, h )
		...
		draw.SimpleText( "JOBS", "RP_CatFont", 30, 203, Color( 255, 255, 255 ) )
		
		draw.SimpleText( table.Count( jobs ).." JOBS BEING USED", "RP_SubFontThick", 92, 197, Color( 0, 0, 0 ) )
		draw.SimpleText( "MOST POPULAR - "..string.upper(team.GetName( table.GetWinningKey( teamTable ) )).." ("..team.NumPlayers(table.GetWinningKey( teamTable )).." PLAYERS)", "RP_SubFontThick", 92, 197 + 17, Color( 190, 190, 190 ) )
	...
	HOME_INFO.Paint = function( self, w, h )
		...
		draw.SimpleText( "TEAM GRAPH", "RP_SubFontThick", 24, 20, Color( 190, 190, 190 ) )
