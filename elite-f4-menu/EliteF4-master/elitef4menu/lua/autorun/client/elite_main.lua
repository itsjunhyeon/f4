...
table.insert( sideButtons, { Title = "DASHBOARD", Func = function() LoadHomePanel() end } )
table.insert( sideButtons, { Title = "COMMANDS", Func = function() LoadCommandPanel() end } )
table.insert( sideButtons, { Title = "JOBS", Func = function() LoadCmdPanel() end } )
table.insert( sideButtons, { Title = "WEAPONS", Func = function() OpenWeaponsTab() end } )
table.insert( sideButtons, { Title = "ENTITIES", Func = function() LoadEntitiesPanel() end } )
table.insert( sideButtons, { Title = "AMMO", Func = function() LoadAmmoPanel() end } )

if ELITE.ShowFoodTab then
	table.insert( sideButtons, { Title = "FOOD", Func = function() LoadFoodPanel() end } )
end

table.insert( sideButtons, { Title = "WEBSITE", Func = function()
	if ELITE.OpenWebsiteInOverlay then
		gui.OpenURL( ELITE.WebsiteURL )
	else
		LoadWebsitePanel()
	end
end } )
